...
public class InfoflowAndroidConfiguration extends InfoflowConfiguration {
	...
	public static class AnalysisFileConfiguration {
		...
		private String dynamicCallGraph = "";
		...
		public void merge(AnalysisFileConfiguration fileConfig) {
			...
			this.dynamicCallGraph = fileConfig.dynamicCallGraph;
		...
		public boolean validate() {
			return targetAPKFile != null && !targetAPKFile.isEmpty() && sourceSinkFile != null
					...
					&& dynamicCallGraph != null && !dynamicCallGraph.isEmpty();
		}
		...
		public String getDynamicCallGraphFile() {
		...
		public void setDynamicCallGraphFile(String dynamicCallGraphFile) {
			this.dynamicCallGraph = dynamicCallGraphFile;
		}
		...
		public int hashCode() {
			...
			result = prime * result + ((dynamicCallGraph == null) ? 0 : dynamicCallGraph.hashCode());
