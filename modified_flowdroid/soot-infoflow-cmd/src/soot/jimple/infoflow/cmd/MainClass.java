...
public class MainClass {
	...
	private static final String OPTION_DYNAMIC_CALL_GRAPH = "dc";
	...
	private void initializeCommandLineOptions() {
		...
		options.addOption(OPTION_DYNAMIC_CALL_GRAPH, "dynamiccallgraph", true, "File that contain the dynamic call graph");
	...
	public static void main(String[] args) throws Exception {
		...
		main.run(args);
		System.out.println(String.format("CALL_GRAPH_SIZE:%d", Scene.v().getCallGraph().size()));
	}
	...
	private void parseCommandLineOptions(CommandLine cmd, InfoflowAndroidConfiguration config) {
		...
		{
			String dynamicCallGraph = cmd.getOptionValue(OPTION_DYNAMIC_CALL_GRAPH);
			if (dynamicCallGraph != null && !dynamicCallGraph.isEmpty())
				config.getAnalysisFileConfig().setDynamicCallGraphFile(dynamicCallGraph);
		}
		{
